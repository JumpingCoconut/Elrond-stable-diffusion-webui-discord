...
async def interface_txt2img(prompt: str = "", seed: int = -1, quantity: int = 1, negative_prompt: str = "", simulate_nai: bool = True):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post("http://localhost:7860/api/predict/", json=data) as resp:
            ...
            server_local_filename = r['data'][0]['value'][0]['name']
            #files = r['data'][0]
    ...
    data = {"fn_index":16,
            "data": [
                      #"{\"prompt\": \"cute\", \"all_prompts\": [\"cute\"], \"negative_prompt\": \"\", \"seed\": 653987583, \"all_seeds\": [653987583], \"subseed\": 2085797738, \"all_subseeds\": [2085797738], \"subseed_strength\": 0, \"width\": 512, \"height\": 512, \"sampler_index\": 0, \"sampler\": \"Euler a\", \"cfg_scale\": 7, \"steps\": 20, \"batch_size\": 1, \"restore_faces\": false, \"face_restoration_model\": null, \"sd_model_hash\": \"925997e9\", \"seed_resize_from_w\": 0, \"seed_resize_from_h\": 0, \"denoising_strength\": null, \"extra_generation_params\": {}, \"index_of_first_image\": 0, \"infotexts\": [\"cute\\nSteps: 20, Sampler: Euler a, CFG scale: 7, Seed: 653987583, Size: 512x512, Model hash: 925997e9, Clip skip: 2\"], \"styles\": [\"None\", \"None\"], \"job_timestamp\": \"20221019182204\", \"clip_skip\": 2}",
                      ",
                      [
                         {
                            "name":server_local_filename,#"C:\\Users\\rwchhs\\AppData\\Local\\Temp\\tmp38r80fot\\tmpnewrq176.png",
                            "data":"file=" + server_local_filename,#C:\\Users\\rwchhs\\AppData\\Local\\Temp\\tmp38r80fot\\tmpnewrq176.png",
                            "is_file":"true"
                         }
                      ],
                      False,
