...
bot = interactions.Client(
    ...
    #intents = interactions.Intents.DEFAULT | interactions.Intents.GUILD_MESSAGES | interactions.Intents.GUILD_MESSAGE_CONTENT
)
            ...
            for embed in message.embeds:
                ...
                if embed.footer:
                    if embed.footer.text:
                        # Fallback in case its an image that was not generated by elrond, they often have other footers
                        try:
